...
MAX_RUNNING_PROCESSES = int(os.environ.get("MAX_RUNNING_PROCESSES", "20"))
...
def updates_handler(message):
    bot.send_message(message.chat.id, "📢 Join our channel: t.me/GennyDied")

@bot.message_handler(func=lambda m: m.text == "📞 Contact Owner")
def contact_handler(message):
    bot.send_message(message.chat.id, "📞 Contact: @GennyDied")
